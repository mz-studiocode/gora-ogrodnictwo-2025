...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Kategorie projekt\u00F3w';
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    displayName: 'Kategorie produkt\u00F3w';
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.Component<'elements.link', false>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStoreProductStoreProduct
  extends Struct.CollectionTypeSchema {
  collectionName: 'strore_products';
  info: {
    displayName: 'Produkty';
    pluralName: 'strore-products';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    specifications: Schema.Attribute.Component<'elements.specification', true>;
